      ...
      <div className="relative mx-auto max-w-md px-6 py-24 text-white">
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-black/10 text-gray-900">
          <label className="block">
            ...
            <input name="name" className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-gray-900/20" required />
          </label>
          ...
          <label className="block">
            ...
            <input name="password" type="password" minLength={6} className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-gray-900/20" required />
          </label>
          ...
          >
            {state === "sending" ? "Creating…" : "Create account"}
          </button>
